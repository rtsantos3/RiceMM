...
=======
  df <- df[(nrow(df) - remove_rows):nrow(df), ]
>>>>>>> 7fa9ab45044879e5534a4088fbefe23e809de02f
...
<<<<<<< HEAD
print(diag_df)
write.csv(diag_df, './converge_stats/diagnostic_stats_run_with_LLFVA_FINAL.csv')
=======
...
I won't bother since convergence rates are ok enough even without trimming.
=======
```{r}
