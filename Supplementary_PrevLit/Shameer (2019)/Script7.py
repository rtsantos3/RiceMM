...
#plastidic ATP shuttles and malate valve constrained  #
#based on published studies is modelled in a scenario #
#when photon uptake not forced on the system. Fluxes  #
#are observed for Figure 5d                           #
#######################################################
...
printFluxesAndFVA(tempModel2,solutiondict_phloem,FVAdict_phloem,outfile="Fluxes_Source_Leaf_ATPandMALshuttlesconstrained_LightNotForced.csv")
